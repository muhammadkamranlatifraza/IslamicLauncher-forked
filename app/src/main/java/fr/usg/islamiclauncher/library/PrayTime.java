...
public class PrayTime {
    ...
    public double julianDate; // Julian date
    // ------------------------------------------------------------
    // Calculation Methods
     ...
     *
     * fa : fajr angle ms : maghrib up_arrow_selector (0 = angle; 1 = minutes after
     * sunset) mv : maghrib parameter value (in angle or minutes) is : isha
     * up_arrow_selector (0 = angle; 1 = minutes after maghrib) iv : isha parameter value
     * (in angle or minutes)
     */
    ...
    public PrayTime() {
         ...
         * fa : fajr angle ms : maghrib up_arrow_selector (0 = angle; 1 = minutes after
         * sunset) mv : maghrib parameter value (in angle or minutes) is : isha
         * up_arrow_selector (0 = angle; 1 = minutes after maghrib) iv : isha parameter
