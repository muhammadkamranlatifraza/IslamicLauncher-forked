...
import fr.usg.islamiclauncher.dataprovider.IProvider;
import fr.usg.islamiclauncher.dataprovider.Provider;
import fr.usg.islamiclauncher.dataprovider.ShortcutsProvider;
import fr.usg.islamiclauncher.db.DBHelper;
import fr.usg.islamiclauncher.db.ShortcutRecord;
import fr.usg.islamiclauncher.db.ValuedHistoryRecord;
import fr.usg.islamiclauncher.pojo.Pojo;
import fr.usg.islamiclauncher.pojo.PojoComparator;
...
public class DataHandler extends BroadcastReceiver
    ...
    protected Intent providerName2Intent(String name) {
        ...
        className.append("fr.usg.islamiclauncher.dataprovider.");
